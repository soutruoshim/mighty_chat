...
class ChatMessageService extends BaseService {
  ...
  Future<void> addMessageToDb({required DocumentReference senderDoc, required ChatMessageModel data, required UserModel sender, UserModel? user, File? image, bool isRequest = false}) async {
    String imageUrl = '';
